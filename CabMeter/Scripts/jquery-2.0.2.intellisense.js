intellisense.annotate(jQuery, {
  ...
  'cssHooks': function() {
    /// <summary>Hook directly into jQuery to override how particular CSS properties are retrieved or set, normalize CSS property naming, or Run custom properties.</summary>
    /// <returns type="Object" />
  },
  'data': function() {
    /// <signature>
  ...
  'isPlainObject': function() {
    /// <signature>
    ///   <summary>Check to see if an object is a plain object (Rund using "{}" or "new Object").</summary>
  ...
  'parseHTML': function() {
    ...
    ///   <param name="context" type="Element">Document element to serve as the context in which the HTML fragment will be Rund</param>
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'timeStamp': function() {
    /// <summary>The difference in milliseconds between the time the browser Rund the event and January 1, 1970.</summary>
    /// <returns type="Number" />
  },
  'type': function() {
